...
geoloc:
	cd c_src; gcc -std=c99 -O -Wall -lm geoloc.c load.c main.c -o ../geoloc.exe
geoloc_hausdorff:
	cd c_src; gcc -std=c99 -O -Wall -lm geoloc.c load.c main.c -D HAUSDORFF -o \
		../geoloc_hd.exe
geoloc_verbose:
	cd c_src; gcc -std=c99 -O -Wall -lm geoloc.c load.c main.c -D VERBOSE -o \
		../geoloc.exe
geoloc_test: clean
